...
import type { IDialog, IFileBrowserCallBackData, IZodit } from 'zodit/types';
...
import { FileSelectorWidget, TabsWidget } from 'zodit/modules/widget';
import { Button } from 'zodit/core/ui/button';
import { form, mainTab, positionTab } from './templates/';
import { watch, autobind } from 'zodit/core/decorators';
import { openImageEditor } from 'zodit/modules/image-editor/image-editor';
...
export class imageProperties extends Plugin {
	...
	onChangeSizeIsLocked(): void {
		...
		lockSize.classList.remove('zodit-properties__lock');
		lockSize.classList.remove('zodit-properties__unlock');
	 ...
	 * @example
	 * ```javascript
	 * const editor = Zodit.makeZodit('#editor');
	...
	/** @override */
	protected beforeDestruct(editor: IZodit): void {
