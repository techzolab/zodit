...
import { Dom, LazyWalker } from 'zodit/core/dom';
import { Plugin } from 'zodit/core/plugin';
import { autobind, cache, watch } from 'zodit/core/decorators';
import {
...
} from 'zodit/plugins/search/helpers';
import { UISearch } from 'zodit/plugins/search/ui/search';

import './config';
import { scrollIntoViewIfNeeded } from 'zodit/core/helpers';
