...
describe('Search plugin', function () {
	const search = Zodit.plugins.get('search');
	...
	describe('Disable option', function () {
		it('Should not init plugin', function () {
			...
			expect(editor.container.querySelector('.zodit-ui-search')).is.null;
	...
	describe('CTRL + F', function () {
		it('Should show search form and query field must have focus', function () {
			...
			expect(editor.container.querySelector('.zodit-ui-search')).is.not
				.null;

			const search = editor.container.querySelector('.zodit-ui-search');
	...
	describe('CTRL + H', function () {
		it('Should show search and replace form and query field must have focus', function () {
			...
			expect(true).equals(
				search.classList.contains('zodit-ui-search_replace_true')
			);
		...
		describe('Press Replace button', function () {
			it('Should replace value form query field to value from replace field in editor', function (done) {
				...
				expect(editor.container.querySelector('.zodit-ui-search')).is
					.null;
				...
				const search =
					editor.container.querySelector('.zodit-ui-search');
	...
	describe('F3 after search', function () {
		...
		it('Should find a next match', function (done) {
			...
			Zodit.modules.Helpers.normalizeNode(editor.editor.firstChild); // because Select module splits text node
		...
		describe('Find by toolbar button event', function () {
			describe('Press Search button', function () {
				it('Should open search dialog', function () {
					...
					expect(editor.container.querySelector('.zodit-ui-search'))
						.is.not.null;
				});
			});
				...
				it('Should open search dialog', function () {
					...
					expect(
						editor.container.querySelector(
							'.zodit-ui-search.zodit-ui-search_replace_true'
						)
					).is.not.null;
				});
			});
