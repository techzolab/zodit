...
import { Eventify } from 'zodit/src/core/event-emitter/eventify';
import type { CanUndef, IAsync, IDestructible } from 'zodit/src/types';
import type { ISpeechRecognize, ISpeechRecognizeResult } from '../interface';
import { spy } from 'zodit/core/decorators/spy/spy';
import { autobind } from 'zodit/src/core/decorators';
