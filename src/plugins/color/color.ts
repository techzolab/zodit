...
import type { IZodit, IControlType } from 'zodit/types';
import { Config } from 'zodit/config';
import { Dom } from 'zodit/modules/';
import { css, dataBind, normalizeColor } from 'zodit/core/helpers/';
import { ColorPickerWidget, TabOption, TabsWidget } from 'zodit/modules/widget';

Config.prototype.controls.brush = {
	update(button, editor: IZodit): void {
	...
	exec(zodit: IZodit, current, { button }): void | false {
 ...
 */
export function color(editor: IZodit): void {
