...
describe('Tooltip plugin tests', function () {
	...
	describe('Zodit tooltip', function () {
		it('Should have different tooltip for each language', function () {
			const area = appendTestArea();

			let editor = Zodit.make(area, {
				toolbarAdaptive: false,
			...
			let tooltip = editor.ownerDocument.querySelector('.zodit-tooltip');
			...
			tooltip = editor.ownerDocument.querySelector('.zodit-tooltip');
