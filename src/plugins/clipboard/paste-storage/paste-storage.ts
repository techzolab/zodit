...
import { attr, toArray } from 'zodit/core/helpers';
...
export class pasteStorage extends Plugin {
	...
	private selectIndex = (index: number): void => {
		if (this.listBox) {
			toArray(
				...
				a.classList.remove('zodit_active');
				if (index === i && this.previewBox) {
					a.classList.add('zodit_active');
	...
	private createDialog(): void {
		...
		this.container.classList.add('zodit-paste-storage');
