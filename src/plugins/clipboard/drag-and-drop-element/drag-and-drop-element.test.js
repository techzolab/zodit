...
describe('Drag and drop element inside Editor', function () {
	const { position } = Zodit.modules.Helpers;
				...
				function () {
					it('Should ' + events[1] + ' dom element', function () {
						...
						editor.value =
							'<p>1111</p>' +
							'<p>2222</p>' +
							'<img style="width: 100px" src="https://techzolab.net/zodit/files/artio.jpg" alt="">' +
							'<p>3333</p>' +
							'<p>4444</p>';
						...
						const result =
							'<p>1111</p>' +
							'<p>22<img alt="" src="https://techzolab.net/zodit/files/artio.jpg" style="width:100px">22</p>' +
							'<p>3333</p>' +
							'<p>4444</p>';
			...
			describe(events[1] + ' image inside anchor', function () {
				it('Should ' + events[1] + ' anchor with image', function () {
					...
					editor.value =
						'<p>1111</p>' +
						'<p>2222</p>' +
						'<a href="#test"><img style="width: 100px" src="https://techzolab.net/zodit/files/artio.jpg" alt=""></a>' +
						'<p>3333</p>' +
						'<p>4444</p>';
					...
					expect(editor.value.replace(/2+/g, '2')).equals(
						'<p>1111</p><p>22<a href="#test"><img style="width: 100px" src="https://techzolab.net/zodit/files/artio.jpg" alt=""></a>22</p><p>3333</p><p>4444</p>'.replace(
							/2+/g,
							'2'
						)
					);
			...
			describe(events[1] + ' image inside table cell', function () {
				it('Should move only image', function () {
					...
					editor.value = `<table>
								<tbody>
									<tr>
										<td class='first'><img style="width: 100px" src="https://techzolab.net/zodit/files/artio.jpg" alt=""></td>
					...
					expect(
						...
						'<table>\n<tbody>\n<tr>\n<td class="first"></td>\n<td class="second"><img alt="" src="https://techzolab.net/zodit/files/artio.jpg" style="width:100px"><br></td>\n</tr>\n</tbody>\n</table>'
					);
				});
			});
			...
			describe('Disable dragging', function () {
				it('Should not move image', function () {
					...
					const defaultValue =
						'<p>1111</p>' +
						'<p>2222</p>' +
						'<p><a href="#test"><img style="width: 100px" src="https://techzolab.net/zodit/files/artio.jpg" alt=""></a></p>' +
						'<p>3333</p>' +
						'<p>4444</p>';
