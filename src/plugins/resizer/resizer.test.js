...
describe('Resize plugin', function () {
	describe('Resize box', function () {
		describe('In relative object', function () {
			it('should be in front of image', function () {
				...
				div.innerHTML =
					...
					'            <textarea id="text__area0"> <img src="https://techzolab.net/zodit/files/artio.jpg" style="border:1px solid red;width:100px;height:100px;"/></textarea>\n' +
					'        </div>\n' +
					'    </div>';

				document.body.appendChild(div);

				const editor = Zodit.make('#text__area0');
				simulateEvent('click', 0, editor.editor.querySelector('img'));

				const resizer = document.querySelector(
					'.zodit-resizer[data-editor_id=text__area0]'
				);
		...
		describe('After resize - popup', function () {
			it('should be hidden and after this should be shown', function () {
				...
				div.innerHTML =
					...
					'        wrong image selection\n' +
					'        <div style="position:relative;text-align: left">\n' +
					'            <textarea id="text__area1"> &lt;img src="https://techzolab.net/zodit/files/artio.jpg" style="border:1px solid red;width:100px;height:100px;"/&gt;</textarea>\n' +
					'        </div>\n' +
					'    </div>';

				document.body.appendChild(div);

				const editor = Zodit.make(
				...
				const resizer = editor.ownerDocument.querySelector(
					'.zodit-resizer[data-editor_id=text__area1]'
				);
				expect(resizer).is.not.null;
				//
				const positionResizer = offset(resizer);
		...
		describe('Resize image', function () {
			const resizeImage = function (editor) {
				...
				const resizer = document.querySelector(
					'.zodit-resizer[data-editor_id=' + editor.id + ']'
				);
				...
				describe('Save aspect ratio', () => {
					describe('Disable useAspectRatio option', () => {
						it("should don't save it", done => {
							...
							editor.value =
								'<p><img src="https://techzolab.net/zodit/files/artio.jpg" style="width: 301px;"/></p>';
							...
							onLoadImage(
								...
								() => {
									...
									expect(sortAttributes(editor.value)).eq(
										'<p><img src="https://techzolab.net/zodit/files/artio.jpg" style="height:159px;width:311px"></p>'
									);
									done();
								}
							);
					...
					describe('Enable useAspectRatio only for table', () => {
						it("should don't save it for images", done => {
							const editor = getZodit({
								resizer: {
									useAspectRatio: Zodit.atom(['table'])
								}
							});
						...
						it('should save it for all', done => {
							...
							onLoadImage(
								...
								() => {
									...
									expect(sortAttributes(editor.value)).eq(
										'<p><img src="https://techzolab.net/zodit/files/artio.jpg" style="height:175px;width:311px"></p>'
									);
									done();
								}
							);
					...
					describe('Enable forImageChangeAttributes', () => {
						describe('Does not has width or height styles', () => {
							it('Should change only attributes width and height', done => {
								...
								editor.value =
									'<p><img src="https://techzolab.net/zodit/files/artio.jpg"/></p>';
								...
								onLoadImage(
									...
									() => {
										...
										expect(sortAttributes(editor.value)).eq(
											'<p><img height="287" src="https://techzolab.net/zodit/files/artio.jpg" width="510"></p>'
										);
										done();
									}
								);
						...
						describe('Has width or height styles', () => {
							describe('Has width style', () => {
								it('Should change attributes width and height and width styles', done => {
									...
									editor.value =
										'<p><img src="https://techzolab.net/zodit/files/artio.jpg" style="width:300px"/></p>';
									...
									onLoadImage(
										...
										() => {
											...
											expect(
												...
												'<p><img height="175" src="https://techzolab.net/zodit/files/artio.jpg" style="width:310px" width="310"></p>'
											);
											done();
										}
									);
							...
							describe('Has height style', () => {
								it('Should change attributes width and height and height styles', done => {
									...
									editor.value =
										'<p><img src="https://techzolab.net/zodit/files/artio.jpg" style="height:300px"/></p>';
									...
									onLoadImage(
										...
										() => {
											...
											expect(
												...
												'<p><img height="306" src="https://techzolab.net/zodit/files/artio.jpg" style="height:306px" width="544"></p>'
											);
											done();
										}
									);
							...
							describe('Has both height and width style', () => {
								it('Should change attributes width and height and width and height styles', done => {
									...
									editor.value =
										'<p><img src="https://techzolab.net/zodit/files/artio.jpg" style="width:300px;height:300px"/></p>';
									...
									onLoadImage(
										...
										() => {
											...
											expect(
												...
												'<p><img height="310" src="https://techzolab.net/zodit/files/artio.jpg" style="height:310px;width:310px" width="310"></p>'
											);
											done();
										}
									);
	...
	describe('For iframes', function () {
		it('should wrap these iframes inside JODIT tag', function () {
			...
			expect(editor.editor.querySelectorAll('zodit').length).equals(2);
			expect(
				editor.editor.querySelector('zodit').firstChild.tagName
			).equals('IFRAME');
		});
		...
		describe('Output HTML', function () {
			it('should not contains JODIT tag', function () {
				...
				expect(editor.editor.querySelectorAll('zodit').length).equals(
					2
				);
