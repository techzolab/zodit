		...
		describe('Click link button', function () {
			describe('Edit exists link', function () {
				describe('Content input was not changed', function () {
					it('Should save link content', function () {
						...
						url.value = 'https://techzolab.ru';

						simulateEvent('submit', 0, popup.querySelector('form'));

						expect(editor.value).equals(
							'<p>test <a href="https://techzolab.ru">link <strong>strong</strong></a> open</p>'
						);
					});
					...
					describe('For relative link', function () {
						it('Should work same way', function () {
							...
							expect(editor.value).equals(
								'<p>test <a href="/zodit/docs/">link <strong>strong</strong></a> open</p>'
							);
						});
					});
				});
				...
				describe('Select some text inside link', function () {
					...
					describe('Content input was changed', function () {
						it("Should open edit popup with full link's content and after submit should replace full link's content", function () {
							...
							content.value = 'https://techzolab.ru';
							...
							expect(editor.value).equals(
								'<p>test <a href="#somelink">https://techzolab.ru</a> open</p>'
							);
						});
					});
				});
			...
			describe('Open LINK insert dialog and insert new link', function () {
				it('Should insert new link', function () {
					...
					expect(
						Boolean(url.closest('.zodit-ui-input_has-error_true'))
					).is.true;
					...
					describe('Selected image', function () {
						describe('On open popup', function () {
							it('Should hide text input', function () {
								...
								editor.value =
									'test <img style="width: 100px;height: 100px" src="https://techzolab.net/zodit/files/artio.jpg" alt=""> stop';
						...
						it('Should wrap selected image in link', function () {
							...
							expect(sortAttributes(editor.value)).equals(
								'<p>test <a href="tests/artio.jpg"><img alt="" src="https://techzolab.net/zodit/files/artio.jpg" style="height:100px;width:100px"></a> stop</p>'
							);
			...
			describe('Was selected part of html', function () {
				...
				describe('Was selected image', function () {
						...
						describe('Edit with contect menu', function () {
							it('Should wrap selected image inside the link', function () {
								...
								editor.value =
									...
									'<tbody>' +
									'<tr>' +
									'<td><img src="https://techzolab.net/zodit/files/artio.jpg" alt="test"></td>' +
									'</tr>' +
									'</tbody>' +
									'</table>';
								...
								expect(
									textInput.closest('.zodit-ui-block').style
										.display
								).equals('none');
								...
								expect(sortAttributes(editor.value)).equals(
									'<p>test</p>' +
										...
										'<tbody>' +
										'<tr>' +
										'<td><a href="./shapiro"><img alt="test" src="https://techzolab.net/zodit/files/artio.jpg"></a></td>' +
										'</tr>' +
										'</tbody>' +
										'</table>'
								);
					...
					describe('Image had not anchor parent', function () {
						it('Should show dialog without content input and after submit wrap this image', function () {
							...
							editor.value =
								'<p>one green <img src="https://techzolab.net/zodit/files/artio.jpg" alt="test"> under wall</p>';
							...
							expect(sortAttributes(editor.value)).equals(
								'<p>one green <a href="https://xdsoft.net"><img alt="test" src="https://techzolab.net/zodit/files/artio.jpg"></a> under wall</p>'
							);
						});
					});
					...
					describe('Image had anchor parent', function () {
						it('Should show dialog without content input and after submit wrap this image', function () {
							...
							editor.value =
								'<p>one green <a href="https://techzolab.ru"><img src="https://techzolab.net/zodit/files/artio.jpg" alt="test"></a> under wall</p>';
							...
							expect(urlInput).is.not.null;
							expect(urlInput.value).equals('https://techzolab.ru');
				...
				describe('After submit this part', function () {
					it('should be wrapped inside anchor', function () {
						...
						const form = popup.querySelector('.zodit-ui-form');
						expect(form).is.not.null;
						...
						input.value = 'https://techzolab.net/zodit/';

						simulateEvent('submit', 0, form);

						expect(editor.value).equals(
							'<p>one <a href="https://techzolab.net/zodit/">green <strong>bottle hanging</strong> under wall</a></p>' +
								'<p><a href="https://techzolab.net/zodit/">two green <em>bottles hanging</em> under</a> wall</p>'
						);
					});
				});
			});
	...
	describe('Link with class name (modeClassName=input/default)', function () {
		describe('Add class name on link', function () {
			it('Should insert new link with a class name', function () {
				...
				expect(editor.value).equals(
					'<p>one <a href="https://techzolab.net/zodit/" class="test">green <strong>bottle hanging</strong> under wall</a></p>' +
						'<p><a href="https://techzolab.net/zodit/" class="test">two green <em>bottles hanging</em> under</a> wall</p>'
				);
			});
		});
		...
		describe('Modify class name on link', function () {
			it('Should modify link with a new class name', function () {
				...
				expect(editor.value).equals(
					'<p>one <a href="https://techzolab.net/zodit/" class="test2">green <strong>bottle hanging</strong> under wall</a></p>' +
						'<p><a href="https://techzolab.net/zodit/" class="test">two green <em>bottles hanging</em> under</a> wall</p>'
				);
			});
		});
	...
	describe('Link with class name (modeClassName=select)', function () {
		describe('Add class name on link', function () {
			it('Should insert new link with a class name', function () {
				...
				expect(editor.value).equals(
					'<p>one <a href="https://techzolab.net/zodit/" class="val1">green <strong>bottle hanging</strong> under wall</a></p>' +
						'<p><a href="https://techzolab.net/zodit/" class="val1">two green <em>bottles hanging</em> under</a> wall</p>'
				);
			});
		});
		...
		describe('Modify class name on link', function () {
			it('Should modify link with a new class name', function () {
				...
				expect(editor.value).equals(
					'<p>one <a href="https://techzolab.net/zodit/" class="val2">green <strong>bottle hanging</strong> under wall</a></p>' +
						'<p><a href="https://techzolab.net/zodit/" class="val1">two green <em>bottles hanging</em> under</a> wall</p>'
				);
			});
		});
	...
	describe('Link with class name (modeClassName="select", selectMultipleClassName=true)', function () {
		describe('Add class name on link', function () {
			it('Should insert new link with a class name', function () {
				...
				expect(editor.value).equals(
					'<p>one <a href="https://techzolab.net/zodit/" class="val1 val3">green <strong>bottle hanging</strong> under wall</a></p>' +
						'<p><a href="https://techzolab.net/zodit/" class="val1 val3">two green <em>bottles hanging</em> under</a> wall</p>'
				);
			});
		});
		...
		describe('Modify class name on link', function () {
			it('Should modify link with a new class name', function () {
				...
				expect(editor.value).equals(
					'<p>one <a href="https://techzolab.net/zodit/" class="val1 val2">green <strong>bottle hanging</strong> under wall</a></p>' +
						'<p><a href="https://techzolab.net/zodit/" class="val1 val3">two green <em>bottles hanging</em> under</a> wall</p>'
				);
			});
		});
