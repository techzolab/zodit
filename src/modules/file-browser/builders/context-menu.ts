...
import type { IDialog, IFileBrowser } from 'zodit/types';
import { Dialog } from 'zodit/modules/dialog';

import { Dom } from 'zodit/core/dom';
import { attr, error } from 'zodit/core/helpers';
import { makeContextMenu } from 'zodit/modules/file-browser/factories';
...
import { elementsMap } from 'zodit/modules/file-browser/builders/elements-map';
import { loadTree } from 'zodit/modules/file-browser/fetch/load-tree';
import { deleteFile } from 'zodit/modules/file-browser/fetch/delete-file';

const CLASS_PREVIEW = 'zodit-filebrowser-preview',
							...
							exec: (): void => {
								const preview = new Dialog({
									...
									temp_content = self.c.div(
										CLASS_PREVIEW,
										'<div class="zodit-icon_loader"></div>'
									),
