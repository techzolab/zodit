...
import { Storage } from 'zodit/core/storage';
import {
	error,
	isFunction,
	isString,
...
import { observable } from 'zodit/core/event-emitter';
...
export class FileBrowser extends ViewWithToolbar implements IFileBrowser {
	 ...
	 * @example
	 * ```javascript
	 * var fb = new Zodit.modules.FileBrowser(parent);
	...
	private initUploader(editor?: IFileBrowser | IZodit): void {
		const self = this,
