...
import type { IDictionary, IFileBrowser } from 'zodit/types';
import { Confirm, Prompt } from 'zodit/modules/dialog';
import { isValidName } from 'zodit/core/helpers/checker';
import { normalizePath } from 'zodit/core/helpers';
