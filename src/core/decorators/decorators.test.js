...
describe('Decorators', () => {
	describe('component', () => {
		...
		beforeEach(() => {
			if (Zodit.esNext) {
				A = class extends Zodit.modules.UIElement {
					className() {
						return 'A';
					}
				...
				DecoratedA = Zodit.decorators.component(A);
			...
			DecoratedB = Zodit.decorators.component(B);
		...
		describe('instanceof', () => {
			it('Should correct work with instanceof B', () => {
				...
				expect(b instanceof Zodit.modules.UIElement).is.true;
			});
			...
			it('Should correct work with instanceof A', () => {
				...
				expect(a instanceof Zodit.modules.UIElement).is.true;
			});
		});
	});
});
