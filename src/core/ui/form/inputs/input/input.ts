...
import { autobind, component, debounce, watch } from 'zodit/core/decorators';
import { Icon } from 'zodit/core/ui/icon';
import { inputValidators } from 'zodit/core/ui/form/validators';
...
export class UIInput extends UIElement implements IUIInput {
	...
	/** @override **/
	constructor(zodit: IViewBased, options?: Partial<IUIInput['state']>) {
		super(zodit, options);
