...
import { autobind, throttle } from 'zodit/core/decorators';
import { Component } from 'zodit/core/component/component';
import { eventEmitter, getContainer } from 'zodit/core/global';
...
export class Popup extends UIElement implements IPopup {
	...
	open(
		...
		markOwner(this.zodit, this.container);
		...
		if (parentContainer) {
			...
			const popupContainer = getContainer(this.zodit, Popup);
	...
	private calculatePosition(
		...
		// Try find match position inside Zodit.container
	...
	constructor(zodit: IViewBased, readonly smart: boolean = true) {
		super(zodit);
