...
import { isFastEqual } from 'zodit/core/helpers/checker/is-equal';
import { isPlainObject } from 'zodit/core/helpers/checker/is-plain-object';
import { getPropertyDescriptor } from 'zodit/core/decorators/watch/watch';
 ...
 * }
 *
 * const obsObj = Zodit.modules.observable(obj);
