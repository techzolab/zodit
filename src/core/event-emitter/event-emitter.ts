...
import { isString, isStringArray } from 'zodit/core/helpers/checker/is-string';
...
export class EventEmitter implements IEventEmitter {
	...
	readonly __key: string = '__ZoditEventEmitterNamespaces';
	 ...
	 * ```javascript
	 *  var events = new Zodit.modules.EventEmitter();
