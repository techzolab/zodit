...
import { setTimeout, clearTimeout } from 'zodit/core/helpers/async';
...
import { isPromise } from 'zodit/core/helpers/checker/is-promise';
import { isString } from 'zodit/core/helpers/checker/is-string';
import { isNumber } from 'zodit/core/helpers/checker/is-number';
...
export class Async implements IAsync {
	 ...
	 * zodit.e.on('mousemove', zodit.async.debounce(() => {
	 * 	// Do expensive things
	 * }, 100));
	 * ```
	 */
	 ...
	 * ```javascript
	 * var zodit = Zodit.make('.editor');
	 * zodit.e.on(document.body, 'scroll', zodit.async.throttle(function() {
	 * 	// Do expensive things
	 * }, 100));
	 * ```
	 */
