...
import type { IDictionary, ILanguageOptions } from 'zodit/types';
import { Config } from 'zodit/config';
import {
	defaultLanguage as defineLanguage,
	error
} from 'zodit/core/helpers/utils';
import { isString } from 'zodit/core/helpers/checker/is-string';
import { ucfirst } from 'zodit/core/helpers/string/ucfirst';
...
/**
 * Internationalization method. Uses Zodit.lang object
 * @example
 * ```javascript
 ...
 *
 * Zodit.defaultOptions.language = 'ru';
 * console.log(Zodit.prototype.i18n('Cancel')) //Отмена
 *
 * Zodit.lang.cs = {
 *    Cancel: 'Zrušit'
 * };
 * Zodit.defaultOptions.language = 'cs';
 * console.log(Zodit.prototype.i18n('Cancel')) //Zrušit
 *
 * Zodit.lang.cs = {
 *    'Hello world': 'Hello \s Good \s'
 * };
 * Zodit.defaultOptions.language = 'cs';
 * console.log(Zodit.prototype.i18n('Hello world', 'mr.Perkins', 'day')) //Hello mr.Perkins Good day
 * ```
 */
