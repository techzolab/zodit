...
import { uniqueUid } from 'zodit/core/global';
import { STATUSES } from 'zodit/core/component/statuses';
import { Async } from 'zodit/core/async';
...
/**
 * The base class of all Zodit UI components. Provides work with a life cycle.
 */
export abstract class Component implements IComponent {
	...
	/**
	 * The document in which zodit was created
	 */
	...
	/**
	 * The window in which zodit was created
	 */
