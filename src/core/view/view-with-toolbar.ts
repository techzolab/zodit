...
import { isString, resolveElement, splitArray } from 'zodit/core/helpers';
...
export abstract class ViewWithToolbar extends View implements IViewWithToolbar {
	...
	override isZodit: boolean = false;

	/** @override **/
	protected constructor(
		options?: Partial<IViewOptions>,
		isZodit: boolean = false
	) {
		super(options, isZodit);
		this.isZodit = isZodit;
