...
return (self["webpackChunk_techzolab_zodit"] = self["webpackChunk_techzolab_zodit"] || []).push([[373],{
...
config_1.Config.prototype.controls.speechRecognize = {
    isActive: function (zodit, _) {
        var api = (0, data_bind_1.dataBind)(zodit, 'speech');
        return Boolean(api === null || api === void 0 ? void 0 : api.isEnabled);
    },
    isDisabled: function (zodit) {
        return !zodit.o.speechRecognize.api;
    },
    exec: function (zodit, current, _a) {
        var button = _a.button, control = _a.control;
        var _b = zodit.o.speechRecognize, Api = _b.api, lang = _b.lang, continuous = _b.continuous, interimResults = _b.interimResults, sound = _b.sound;
        if (!Api) {
        ...
        if (!api) {
            ...
            api = new recognize_manager_1.RecognizeManager(zodit.async, nativeApi);
            api.lang = lang;
            api.continuous = continuous;
            api.interimResults = interimResults;
            api.sound = sound;
            (0, data_bind_1.dataBind)(zodit, 'speech', api);
            api.on('pulse', function (enable) {
                button.setMod('pulse', enable);
            });
            api.on('result', function (text) {
                return zodit.e.fire('speechRecognizeResult', text);
            });
            api.on('progress', function (text) {
                return zodit.e.fire('speechRecognizeProgressResult', text);
            });
    ...
    childTemplate: function (zodit, key, value) {
        var _a;
        var api = (0, data_bind_1.dataBind)(zodit, 'speech'), checked = (_a = api === null || api === void 0 ? void 0 : api[key]) !== null && _a !== void 0 ? _a : zodit.o.speechRecognize[key];
        return "<span class='zodit-speech-recognize__list-item'><input ".concat(checked ? 'checked' : '', " class='zodit-checkbox' type='checkbox'>&nbsp;").concat(value, "</span>");
    },
    mods: {
        stroke: false
    }
...
function execSpellCommand(zodit, commandSentence) {
...
var SpeechRecognizeNative = (function (_super) {
    ...
    SpeechRecognizeNative.prototype.afterInit = function (zodit) {
        var _this = this;
        var commands = zodit.o.speechRecognize.commands;
        if (commands) {
            ...
            (0, utils_1.keys)(commands, false).forEach(function (words) {
                ...
                keys.forEach(function (key) {
                    ...
                    var translatedKeys = zodit.i18n(key);
    ...
    SpeechRecognizeNative.prototype.beforeDestruct = function (zodit) { };
    SpeechRecognizeNative.prototype.onSpeechRecognizeProgressResult = function (text) {
        var _this = this;
        if (!this.messagePopup) {
            this.messagePopup = this.j.create.div('zodit-speech-recognize__popup');
        }
...
if (typeof Zodit !== 'undefined') {
    Zodit.plugins.add('speech-recognize', SpeechRecognizeNative);
}
